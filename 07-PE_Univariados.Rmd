...
```{r pacfamzn, fig.cap="Función de Autocorrelación parcial de la serie de tiempo de AMZN", warning=FALSE, message=FALSE}
pacf(price_amazn_ts, main="", lag.max = 60)
```
```{r acfamzn, fig.cap="Función de Autocorrelación de la serie de tiempo de AMZN", warning=FALSE, message=FALSE}
acf(price_amazn_ts, main="", lag.max = 60)
```

```{r LAGamazn20, fig.cap="5 plots de correlacion de los lags de la serie de tiempo de AMZN", warning=FALSE, message=FALSE}
...
Raices:
```{r amazn20root20, fig.cap="Raices AR(1) Inversas de la serie de tiempo", warning=FALSE, message=FALSE}
plot.armaroots(arroots(AR_price_amazn_ts_1), main="Raices inversas de AR(1)")
```

Plot:
```{r amazn20AR20, fig.cap="Diferencia entre la serie de tiempo original de precios de AMZN y su AR(1)", warning=FALSE, message=FALSE}
...
Raices MA(A):
```{r amazn20rootma1, fig.cap="Raices MA(1) Inversas de la serie de tiempo", warning=FALSE, message=FALSE}
...
Plot:
```{r amazn20AR1, fig.cap="Diferencia entre la serie de tiempo original de precios de AMZN y su AR(1)", warning=FALSE, message=FALSE}
