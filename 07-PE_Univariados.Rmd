...
```{r fig.show='hide', echo=FALSE, message=FALSE, , echo=TRUE, fig.align='center', out.width="100%"}
...
```{r, results='asis', echo=FALSE, fig.align='center', out.width="100%"}
arima111<-stats::arima(price_amazn_ts,order=c(1,1,1),method = "ML")
stargazer(arima111,type = "html", 
          notes=c("(p<0.1)=[*], (p<0.05)=[**], (p<0.01)=[***]"),
          title ="ARMA(1,1,1) de los precios de apertura de AMZN")
```
