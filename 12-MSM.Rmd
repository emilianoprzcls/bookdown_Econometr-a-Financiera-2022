...
mu_hist<-ggplot(dist.garch.amzn011,aes(x=mu))+geom_histogram(aes(fill=..count..))+scale_fill_gradient(low="#1e313b", high="#65c7f7")+theme_light()+geom_vline(xintercept = mean(x=dist.garch.amzn011$mu, na.rm=TRUE), color="black", size=1)+annotate(geom = "text", x = (mean(x=dist.garch.amzn011$mu,na.rm=TRUE)+sd(x=dist.garch.amzn011$mu,na.rm=TRUE)), y=40, label=paste("Media=",mean(x=dist.garch.amzn011$mu,na.rm=TRUE)))+labs(title="Disttibución Mu",x="Mu", y="Frecuencia", fill = "Frecuencia")
mu_hist
```

```{r Ma1, fig.cap = "Histograma de $MA_1$", echo=FALSE, out.width="100%"}
ma1_hist<-ggplot(dist.garch.amzn011,aes(x=ma1))+geom_histogram(aes(fill=..count..))+scale_fill_gradient(low="#1e313b", high="#65c7f7")+theme_light()+geom_vline(xintercept = mean(x=dist.garch.amzn011$ma1, na.rm=TRUE), color="black", size=1)+annotate(geom = "text", x = (mean(x=dist.garch.amzn011$ma1,na.rm=TRUE)+sd(x=dist.garch.amzn011$ma1,na.rm=TRUE)), y=40, label=paste("Media=",mean(x=dist.garch.amzn011$ma1,na.rm=TRUE)))+labs(title="Disttibución ma1",x="ma1", y="Frecuencia", fill = "Frecuencia")
ma1_hist
```

```{r Ma2, fig.cap = "Histograma de $MA_2$", echo=FALSE, out.width="100%"}
ma2_hist<-ggplot(dist.garch.amzn011,aes(x=ma2))+geom_histogram(aes(fill=..count..))+scale_fill_gradient(low="#1e313b", high="#65c7f7")+theme_light()+geom_vline(xintercept = mean(x=dist.garch.amzn011$ma2, na.rm=TRUE), color="black", size=1)+annotate(geom = "text", x = (mean(x=dist.garch.amzn011$ma2,na.rm=TRUE)+sd(x=dist.garch.amzn011$ma2,na.rm=TRUE)), y=40, label=paste("Media=",mean(x=dist.garch.amzn011$ma2,na.rm=TRUE)))+labs(title="Disttibución ma2",x="ma2", y="Frecuencia", fill = "Frecuencia")
ma2_hist
```

```{r omega, fig.cap = "Histograma de $\\Omega$", echo=FALSE, out.width="100%"}
omega_hist<-ggplot(dist.garch.amzn011,aes(x=omega))+geom_histogram(aes(fill=..count..))+scale_fill_gradient(low="#1e313b", high="#65c7f7")+theme_light()+geom_vline(xintercept = mean(x=dist.garch.amzn011$omega, na.rm=TRUE), color="black", size=1)+annotate(geom = "text", x = (mean(x=dist.garch.amzn011$omega,na.rm=TRUE)+sd(x=dist.garch.amzn011$omega,na.rm=TRUE)), y=40, label=paste("Media=",mean(x=dist.garch.amzn011$omega,na.rm=TRUE)))+labs(title="Disttibución omega",x="omega", y="Frecuencia", fill = "Frecuencia")
omega_hist
```

```{r beta1, fig.cap = "Histograma de $\beta_1$", echo=FALSE, out.width="100%"}
beta1_hist<-ggplot(dist.garch.amzn011,aes(x=beta1))+geom_histogram(aes(fill=..count..))+scale_fill_gradient(low="#1e313b", high="#65c7f7")+theme_light()+geom_vline(xintercept = mean(x=dist.garch.amzn011$beta1, na.rm=TRUE), color="black", size=1)+annotate(geom = "text", x = (mean(x=dist.garch.amzn011$beta1,na.rm=TRUE)+sd(x=dist.garch.amzn011$beta1,na.rm=TRUE)), y=40, label=paste("Media=",mean(x=dist.garch.amzn011$beta1,na.rm=TRUE)))+labs(title="Disttibución beta1",x="beta1", y="Frecuencia", fill = "Frecuencia")
beta1_hist
```
